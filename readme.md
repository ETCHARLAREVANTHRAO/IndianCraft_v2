...
### 2.1 Buffer Adequacy Score (BAS)
Measures whether the itinerary includes sufficient temporal buffers for expected uncertainty.

**Per activity $i$:**
$$ BAS_i = \min(1, \frac{B_i}{E[D_i]}) $$

**Where:**
- $B_i$: Buffer added before the next activity
- $E[D_i]$: Expected delay from historical data

**Aggregate Score:**
$$ BAS = \frac{1}{N} \sum_{i=1}^{N} BAS_i $$
